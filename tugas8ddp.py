print("")
print("1.print semua bilangan ganjil dari list berikut, hentikan perulangan ketika sudah melewati bilangan ketika sudah melewati bilangan 553, pakai perulangan while")
print("")
...
#menggunakan  loop whileuntuk mencetak bilangan ganjil sampai bertemu dengan 553
